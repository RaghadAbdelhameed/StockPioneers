...
public class Execute {
	public static void main(String[] args) {
		...
		System.out.println("****");
		regUser1.displayPriceHistory("APPL");
...
////
//// // Transaction t1 = new Transaction(4 , "APPL" , Operation.deposit , 5 ,
//// 120);
//// // System.out.println(t1.toString());
////
//// Transaction t1 = new Transaction(4 , "Heart" , Operation.deposit , 5 ,
//// 120);
//// Transaction t2 = new Transaction(4 , "Heart" , Operation.withdrawal , 3 ,
//// 120);
...
//// TradingManager td = new TradingManager();
//// Admin admin = Admin.getInstance("Zeyad" , "Zeyad74" , 7 , 100 , gender.male
//// , td);
//// RegularUser regUser1 = new RegularUser("loly" , "loly711" , 1 , 1000 ,
//// gender.female);
////
...
// RegularUser regUser1 = new RegularUser("loly", "loly711", 14, 500,
//// gender.female);
// // regUser1.trackMarket();
// regUser1.deposit(120);
// admin.approveDeposit(regUser1, 250, t1);
