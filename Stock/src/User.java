...
public abstract class User {
	...
	// protected static Map<String, List<Stock>> Prices = new HashMap<>(); // Map to
	// store stock price by stock label
	private MarketPerformanceTracker marketTracker;
	// protected static Map<String, List<Transaction>> Transactions = new
	// HashMap<>(); // Map to store stock orders by stock label
	...
	// gender gender,MarketPerformanceTracker marketTracker) {
	// this.username = username;
	// this.password = password;
